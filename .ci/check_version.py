...
Check version number in setup.json and aiida_sirius/__init__.py and make sure
they match.
"""
...
import aiida_sirius  # pylint: disable=wrong-import-position
version = aiida_sirius.__version__
